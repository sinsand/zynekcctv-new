...
function template_main()
{
	...
	if (!$settings['gallery_slideshow'])
	{
	echo '
	<table border="0" width="100%" class="tborder" cellspacing="' , ($context['browser']['is_ie'] || $context['browser']['is_opera6']) ? '1' : '0' , '" cellpadding="4" style="margin-bottom: 2ex;">
		<tr>
			<td class="catbg"> &nbsp;', $txt[9388], '</td>
		</tr>
		<tr>
			<td valign="middle" align="center" height="60">';

		// Gallery Slideshow by smfclub.com Prepare all the javascript settings.
		echo '
 ...
 <body>
  ...
  <div id="header"><div class="wrap">
   <div id="slide-holder">
<div id="slide-runner">
<a href="', $settings['url_slideshow_images_1'], '"><img id="slide-img-1"  src="', $settings['gallery_slideshow_images_1'], '" /></a>
<a href="', $settings['url_slideshow_images_2'], '"><img id="slide-img-2"  src="', $settings['gallery_slideshow_images_2'], '" /></a>
<a href="', $settings['url_slideshow_images_3'], '"><img id="slide-img-3"  src="', $settings['gallery_slideshow_images_3'], '" /></a>
<a href="', $settings['url_slideshow_images_4'], '"><img id="slide-img-4"  src="', $settings['gallery_slideshow_images_4'], '" /></a>
<a href="', $settings['url_slideshow_images_5'], '"><img id="slide-img-5"  src="', $settings['gallery_slideshow_images_5'], '" /></a>
<a href="', $settings['url_slideshow_images_6'], '"><img id="slide-img-6"  src="', $settings['gallery_slideshow_images_6'], '" /></a>
<a href="', $settings['url_slideshow_images_7'], '"><img id="slide-img-7"  src="', $settings['gallery_slideshow_images_7'], '" /></a>
   ...
   <script type="text/javascript">
    if(!window.slider) var slider={};slider.data=[{"id":"slide-img-1","client":"', $settings['post_slideshow_1'], '","desc":"', $settings['description_slideshow_1'], '"},{"id":"slide-img-2","client":"', $settings['post_slideshow_2'], '","desc":"', $settings['description_slideshow_2'], '"},{"id":"slide-img-3","client":"', $settings['post_slideshow_3'], '","desc":"', $settings['description_slideshow_3'], '"},{"id":"slide-img-4","client":"', $settings['post_slideshow_4'], '","desc":"', $settings['description_slideshow_4'], '"},{"id":"slide-img-5","client":"', $settings['post_slideshow_5'], '","desc":"', $settings['description_slideshow_5'], '"},{"id":"slide-img-6","client":"', $settings['post_slideshow_6'], '","desc":"', $settings['description_slideshow_6'], '"},{"id":"slide-img-7","client":"', $settings['post_slideshow_7'], '","desc":"', $settings['description_slideshow_7'], '"}];
   </script>
  </div></div><!--/header-->
  	</td>
		</tr>
