...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			...
			array(
			'id' => 'post_slideshow_1',
			'label' => $txt['slideshow_post'],
			'type' => 'text',
				),
							array(
			'id' => 'description_slideshow_1',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
			array(
			'id' => 'gallery_slideshow_images_1',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
				),
					array(
			'id' => 'url_slideshow_images_1',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
						array(
			'id' => 'post_slideshow_2',
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_2',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
			array(
			'id' => 'gallery_slideshow_images_2',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		
			),
								array(
			'id' => 'url_slideshow_images_2',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
						array(
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_3',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
						array(
			'id' => 'gallery_slideshow_images_3',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		
			),					array(
			'id' => 'url_slideshow_images_3',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_4',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
						array(
			'id' => 'gallery_slideshow_images_4',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		
			),
								array(
			'id' => 'url_slideshow_images_4',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
						array(
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_5',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
						array(
			'id' => 'gallery_slideshow_images_5',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		
			),
								array(
			'id' => 'url_slideshow_images_5',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
						array(
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_6',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
						array(
			'id' => 'gallery_slideshow_images_6',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		
			),
								array(
			'id' => 'url_slideshow_images_6',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
			),
						array(
			...
			'type' => 'text',
							...
							array(
			'id' => 'description_slideshow_7',
			'label' => $txt['slideshow_description'],
			'type' => 'text',
				),
						array(
			'id' => 'gallery_slideshow_images_7',
			'label' => $txt['gallery_slideshow_images_url'],
			'type' => 'text',
		),
							array(
			'id' => 'url_slideshow_images_7',
			'label' => $txt['url_slideshow_images_url'],
			'type' => 'text',
