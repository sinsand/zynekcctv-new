...
if (isset($_POST['SubmitUpload'])) {
  // code...
    ...
    if (update_tbz($sqlupdate)==true) {
      ...
      if ($suminsert_error ==0) {
        if ($sumupdate_error ==0) {
          ?>
          <div class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4><i class="icon fa fa-warning"></i> Alert!</h4>
            เพิ่มข้อมูลได้สำเร็จ.<br>
            เพิ่มข้อมูล : <?=$suminsert_true;?> รายการ
          </div>
          ...
          <div class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4><i class="icon fa fa-warning"></i> Alert!</h4>
            เปลี่ยนแปลงข้อมูลได้สำเร็จ.<br>
            เปลี่ยนแปลงข้อมูล : <?=$sumupdate_true;?> รายการ
          </div>
          <?
        }else {
          ?>
        ...
        if ($sumupdate_error ==0 ) {
          ...
          <div class="alert alert-warning alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4><i class="icon fa fa-warning"></i> Alert!</h4>
            ไม่สามารถเพิ่มข้อมูลได้.<br>
            การเพิ่มข้อมูลได้ : <?=$suminsert_true;?> รายการ<br>
            การเพิ่มข้อมูลผิดพลาด : <?=$suminsert_true;?> รายการ
          </div>
          <?
        }else {
          ?>
          <div class="alert alert-warning alert-dismissible">
            ...
            การเพิ่มข้อมูลได้ : <?=$suminsert_true;?> รายการ<br>
            การเพิ่มข้อมูลผิดพลาด : <?=$suminsert_true;?> รายการ<br>
            <br>
                ...
                <div class="box-body">
                  <div class="col-xs-12">
                    <div class="form-group">
                      ...
                      <p class="help-block">ตัวอย่างไฟล์ <a href="<?=SITE_URL;?>download/stock_original_file.xlsx">(ดาวโหลด)</a></p>
                    </div>
                    <div class="checkbox">
                      <label>
...
<script>
  $(document).ready(function() {
    ...
    $(".modal-delete").click(function(event) {
      ...
      $(".btn_delete_stock").attr("id",$(this).attr("id"));
    });
    ...
    $(".btn_delete_stock").click(function(event) {
      ...
      function(d) {
        ...
        var i = d.split("|||");
        if (i[0]==1) {
          $("#show_delete_stock_show").html(i[1]);
          setTimeout(function(){
            window.location.href = "<?=$HostLinkAndPath;?>";
          },2000);
        }else {
      ...
      <div class="modal-body">
        <form>
          <div class="form-group" style="text-align: center; margin: 0;">
            <div class="control-label" id="show_delete_stock_show" style="padding:25px 0;">สินค้า <label class="show_data_value">MAXXXXXX</label></div>
          </div>
        </form>
      </div>
